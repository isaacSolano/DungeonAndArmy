...
public class Glognar implements Soldier {
    private static final String category = "Artillería";
    private final String name = "Glognar";
    private ImageView image = new ImageView("Media/Army/Glognar.png");
    ...
    public Glognar(String coords, int move, int life, int attack, int defense, int specialAttack) {
        this.coords = coords;
        this.move = move;
        this.life = life;
        this.attack = attack;
